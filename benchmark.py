...
def calc_score(metric_data, weights=(0.2, 0.2, 0.15, 0.15, 0.1, 0.1, 0.1)):
    ...
    funcs = (detection_time_func, pa_func, detection_time_std_func, pa_std_func, mistake_duration_func,
             cpu_time_func, memory_func)

    names = ("detection time", "pa", "detection time std", "pa std", "mistake duration", "CPU time", "memory usage")
...
def feed_to_visual(algo_name, metric_data, visual_data=None, weights=(0.2, 0.2, 0.15, 0.15, 0.1, 0.1, 0.1)):
...
if __name__ == '__main__':
    accural_data = (105.74858808928572, 0.9979379611895526, 1.6750364820071866, 0.0008348593499185055,
                    9364.899149998326, 0.6029575892857143, 110.89264787946429)
    bertier_data = (100.91581011049107, 0.9112516167575638, 1.059675334140229, 0.02535474631119393, 644043.3404513125,
                    0.375, 82.63825334821429)
    chen_data = (100.09092747600445, 0.7423359876953095, 0.9009301070789003, 0.08329813139516726,
